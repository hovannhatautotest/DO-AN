...
*** Variables ***
${Số fax invalid}             842344932
${Số điện thoại invalid}      0944852025
${Email invalid}              61t6134109@husc.edu.vn
*** Test Cases ***
...
#    And Click "Quản lý chi nhánh" sub menu
...
#    And Enter "fax_valid" in "Số fax" with "${Số fax invalid}"
...
#    And Enter "phone" in "Số điện thoại đại diện" with "${Số điện thoại invalid}"
#    And Enter "Email" in "Email đại diện" with "_RANDOM_"
#    And Click "Lưu" button
...
#    And Enter "fax_valid" in "Số fax" with "_RANDOM_"
#    And Enter "phone" in "Số điện thoại đại diện" with "_RANDOM_"
#    And Enter "Email" in "Email đại diện" with "${Email invalid}"
#    And Click "Lưu" button
...
#    And Enter "phone" in "Số điện thoại đại diện" with "_RANDOM_"
#    And Enter "Email" in "Email đại diện" with "_RANDOM_"
#    And Enter "paragraph" in textarea "Ghi chú" with "Cửa hàng thú cưng và sản phẩm liên quan."
#    And Click "Lưu" button
...
#    Then User look title "Quản Lý Cửa Hàng"
#    And User look contains title is "Quản lý chi nhánh"
#
...
#    When Go to list Branch Store page
#    And Search "text" in "Tìm kiếm" with "STR0172"
#    Then Show list of "Branch Stores"
#
...
#    When Go to list Branch Store page
#    And Search "text" in "Tìm kiếm" with "ARI Mart"
#    Then Show list of "Branch Stores"
#
...
#    When Go to list Branch Store page
#    And Search "text" in "Tìm kiếm" with "Lê Thị Vỹ Dạ"
#    Then Show list of "Branch Stores"
#
...
#    When Go to list Branch Store page
#    And Search "text" in "Tìm kiếm" with "0944852025"
#    Then Show list of "Branch Stores"
#
...
#    Then User look title "Quản Lý Cửa Hàng"
#    And User look contains title is "Cửa hàng"
#
####==================================VALIDATION TEXT==========================================================
...
#    Then Required message "Email đại diện" displayed under "Vui lòng nhập địa chỉ email hợp lệ!" field
#
#Edit_Branch_Store_20: Kiểm tra Validation Text trường "client_id" khi không nhập client_id
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
#    [Documentation]   Kiểm tra Validation Text trường "client_id" khi không nhập client_id
#    When Go to edit Branch Store page
#    And Click switch "Kết nối KiotViet" to be activated
...
#    Then Required message "client_id" displayed under "Xin vui lòng nhập client_id" field
#
#Edit_Branch_Store_21: Kiểm tra Validation Text trường "client_secret" khi không nhập client_secret
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
#    [Documentation]   Kiểm tra Validation Text trường "client_secret" khi không nhập client_secret
#    When Go to edit Branch Store page
#    And Click switch "Kết nối KiotViet" to be activated
...
#    Then Required message "client_secret" displayed under "Xin vui lòng nhập client_secret" field
#
#Edit_Branch_Store_22: Kiểm tra Validation Text trường "retailer" khi không nhập retailer
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
#    [Documentation]   Kiểm tra Validation Text trường "retailer" khi không nhập retailer
#    When Go to edit Branch Store page
#    And Click switch "Kết nối KiotViet" to be activated
...
#    Then Required message "retailer" displayed under "Xin vui lòng nhập retailer" field
#
#Edit_Branch_Store_23: Kiểm tra Validation Text trường "branchId" không nhập branchId
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
#    [Documentation]   Kiểm tra Validation Text trường "branchId" không nhập branchId
#    When Go to edit Branch Store page
#    And Click switch "Kết nối KiotViet" to be activated
...
#
###=================================ERROR MESSAGE===============================================================================================
#Edit_Branch_Store_24: Kiểm tra Error Message khi chỉnh sửa cửa hàng chi nhánh với Số fax đã được đăng kí trước đó
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
#    [Documentation]   Kiểm tra hiển thị thông báo lỗi khi chỉnh sửa cửa hàng chi nhánh với Số fax đã được đăng kí trước đó
#    When Go to edit Branch Store page
#    When Enter "fax_valid" in "Số fax" with "${Số fax invalid}"
#    And Click "Lưu" button
#    Then User look message "Số Fax đã được đăng kí trước đó." popup

#Edit_Branch_Store_25: Kiểm tra Error Message khi chỉnh sửa cửa hàng chi nhánh với Số điện thoại đã được đăng kí trước đó
...
#    When Go to edit Branch Store page
#    When Enter "phone" in "Số điện thoại đại diện" with "${Số điện thoại invalid}"
#    And Click "Lưu" button
#    Then User look message "Số điện thoại đã được đăng ký trước đó." popup

#Edit_Branch_Store_26: Kiểm tra Error Message khi chỉnh sửa cửa hàng chi nhánh với Email đã được đăng kí trước đó
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
...
#
#Edit_Branch_Store_27: Kiểm tra Error Message khi Không tìm thấy kết nối với kiot-viet
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
#    [Documentation]   Kiểm tra hiển thị thông báo lỗi khi Không tìm thấy kết nối với kiot-viet
#    When Go to edit Branch Store page
#    And Click switch "Kết nối KiotViet" to be activated
...
#Edit_Branch_Store_28: Kiểm tra chỉnh sửa thông tin cửa hàng chi nhánh thành công khi thay đổi "Tên cửa hàng"
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
#    [Documentation]   Kiểm tra chỉnh sửa thông tin cửa hàng chi nhánh thành công khi thay đổi "Tên cửa hàng"
#    When Go to edit Branch Store page
#    And Enter "text" in "Tên cửa hàng" with "ARI Mart"
#    And Click "Lưu" button
#    Then User look message "Chỉnh sửa cửa hàng thành công." popup
#
#Edit_Branch_Store_29: Kiểm tra chỉnh sửa thông tin cửa hàng chi nhánh thành công khi thay đổi "Số fax"
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
...
#    Then User look message "Chỉnh sửa cửa hàng thành công." popup
#
#Edit_Branch_Store_30: Kiểm tra chỉnh sửa thông tin cửa hàng chi nhánh thành công khi thay đổi "Địa chỉ cửa hàng"
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
...
#    Then User look message "Chỉnh sửa cửa hàng thành công." popup
#
#Edit_Branch_Store_31: Kiểm tra chỉnh sửa thông tin cửa hàng chi nhánh thành công khi thay đổi "Họ tên người đại diện"
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
#    [Documentation]   Kiểm tra chỉnh sửa thông tin cửa hàng chi nhánh thành công khi thay đổi "Họ tên người đại diện"
#    When Go to edit Branch Store page
#    And Enter "fullname" in "Họ tên đại diện" with "Lê Thị Vỹ Dạ"
#    And Click "Lưu" button
#    Then User look message "Chỉnh sửa cửa hàng thành công." popup
#
#Edit_Branch_Store_32: Kiểm tra chỉnh sửa thông tin cửa hàng chi nhánh thành công khi thay đổi "Số điện thoại người đại diện"
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
...
#    Then User look message "Chỉnh sửa cửa hàng thành công." popup
#
#Edit_Branch_Store_33: Kiểm tra chỉnh sửa thông tin cửa hàng chi nhánh thành công khi thay đổi "Email người đại diện"
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
...
#    Then User look message "Chỉnh sửa cửa hàng thành công." popup
#
#Edit_Branch_Store_34: Kiểm tra điều hướng đến trang “Quản lý cửa hàng chi nhánh” từ trang “Chỉnh sửa cửa hàng chi nhánh”
#    [Tags]    @Test_Edit_Branch_Store    @Test_by_Hồ_Văn_Nhật
...
Select Branch Store need to edit
    Search "text" in "Tìm kiếm" with "STR0172"
    ${element}    Set Variable   //td[contains(text(),'STR0172')]
...
Enter default information
  And Enter "text" in "Tên cửa hàng" with "Nhà Hàng Hương Việt"
  And Click select "Tỉnh/Thành phố" with "Thành phố Đà Nẵng"
  And Click select "Quận/Huyện" with "Quận Sơn Trà"
  And Click select "Phường/Xã" with "Phường Phước Mỹ"
  And Enter "text" in "Địa chỉ cụ thể" with "01 Hoàng Hoa Thám"
  And Enter "fullname" in "Họ tên đại diện" with "Thái Phúc Như"
...
Display
    ...
    FOR  ${i}  IN  @{elements}
        ...
        Log               ${stt}. Mã cửa hàng: ${store_code} | Tên cửa hàng: ${store_name} | Địa chỉ: ${address} | Người đại diện: ${store_user} | Số điện thoại: ${phone} | Trạng thái: ${status}
        Log To Console    ================================================================================================================================================================================
    ...
    Log               Tổng số lượng cửa hàng chi nhánh là: ${total}
